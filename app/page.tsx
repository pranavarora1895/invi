      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal ${lusitana.className} antialiased`}>
            <strong>Welcome to Invi.</strong> Welcome to Invi, the next-generation invoice management system designed to simplify your financial processes and enhance your business efficiency. With cutting-edge AI technology at its core, Invi offers a suite of intelligent features tailored to meet the diverse needs of businesses of all sizes.
          </p>
          <Link
            href="/login"
